import { GeofenceRayCastingRust } from '.';
import { data } from './geofence.fixtures';

const GeofenceRayCastingRustFactory = (): GeofenceRayCastingRust => {
    const geofence = new GeofenceRayCastingRust();

    return geofence;
};

describe('GeofenceRayCastingRust Test', () => {
    const geofence = GeofenceRayCastingRustFactory();
